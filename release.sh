...
## How to get and use?
# git clone "https://github.com/zly8686/GFWList2AGH.git" && bash ./GFWList2AGH/release.sh
...
function GetData() {
    ...
    gfwlist2agh_modify=(
        "https://raw.githubusercontent.com/zly8686/GFWList2AGH/source/data/data_modify.txt"
    )
    ...
    case ${software_name} in
        adguardhome)
            domestic_dns=(
                ...
                # "tls://1.12.12.12:853"
                # "https://208.67.220.220:443/dns-query"
                # "https://149.112.112.12:443/dns-query"
                # "tls://8.8.4.4:853"
                # "tls://1.0.0.1:853"
            ...
            foreign_dns=(
                ...
                # "https://146.112.41.2:443/dns-query"
